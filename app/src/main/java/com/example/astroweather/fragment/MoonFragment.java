...
import com.example.astroweather.presenter.MoonPresenter;
...
public class MoonFragment extends Fragment {
    ...
    public TextView moonRiseTime;

    @BindView(R.id.moonset_time)
    public TextView moonSetTime;

    @BindView(R.id.nearest_new_moon)
    public TextView nearestNewMoon;

    @BindView(R.id.nearest_full_moon)
    public TextView nearestFullMoon;

    @BindView(R.id.moon_phase)
    public TextView moonPhase;

    @BindView(R.id.synodic_month_day)
    public TextView synodicMonthDay;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        moonPresenter = new MoonPresenter();
        moonPresenter.attachView(this);
    }
